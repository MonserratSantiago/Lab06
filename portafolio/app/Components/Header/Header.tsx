...
let HeaderDat:String = 'Monserrat Guadalupe Del Angel Santiago'
    ...
    return(
        ...
        <nav className="nav container">
            <a href="#home" className="nav__logo">
                <span className="logo__bracket">&lt;</span>Monserrat Guadalupe Del Angel Santiago<span className="logo__bracket">/&gt;</span>
            </a>
