          ...
          <article className={styles.project__card}>
            <div className={styles.project__image}>
              ...
              <div className={styles.project__overlay}>
                ...
                <a 
                  href="https://github.com/MonserratSantiago8/MonserratDelAngel_Amazon" 
                  target="_blank" 
          ...
          <article className={styles.project__card}>
            <div className={styles.project__image}>
              ...
              <div className={styles.project__overlay}>
                ...
                <a 
                  href="https://github.com/tu-usuario/proyecto-2" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className={styles.project__link}
                >
          ...
          <article className={styles.project__card}>
            <div className={styles.project__image}>
              ...
              <div className={styles.project__overlay}>
                ...
                <a 
                  href="https://github.com/tu-usuario/proyecto-3" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className={styles.project__link}
                >
